    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        write!(
            ...
            match self {
                ...
                ApplyForParentAccounts =>  "apply_for_parent_accounts",
                CreateChildVaspAccount => "create_child_vasp_account",
                GrantParentAccounts => "grant_parent_accounts",
                ApprovedPayment => "approved_payment",
                Burn => "burn",
                CancelBurn => "cancel_burn",
                CreateAccount => "create_account",
                CreateRootVaspAccount => "create_root_vasp_account",
